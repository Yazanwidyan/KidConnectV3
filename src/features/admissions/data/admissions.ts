...
export const admissions = Array.from({ length: 500 }, () => {
  const name = faker.person.firstName() + " Admission"
  ...
  return {
    ...
    name,
    color,
    admissionType: faker.helpers.arrayElement(['infants', 'toddlers', 'preschool']),
